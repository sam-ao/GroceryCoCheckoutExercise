...
*/
public class SalePromotionParser : IPromotionParser
{
    ...
    {
        get { return PromotionTypesEnum.Sale; }
    }
    ...
    public IPromotion ParsePromotion(string[] promotionStringArray)
    {
        ...
        try 
        {
            ...
            promotion = new SalePromotion(promotionId, saleItemId, discountType, discountValue);
        }
        catch (Exception e) when (e is FormatException || e is OverflowException || e is KeyNotFoundException)
        {
            throw new PromotionParseException("Invalid sale promotion entry format.", e);
        }
